    ...
    <>
      ...
      <header className="glass-nav sticky top-0 z-50 border-b border-[rgba(0,17,58,0.06)]">
        ...
        <div className="mx-auto flex max-w-7xl flex-col gap-3 px-4 py-3 sm:px-6 sm:py-4 md:flex-row md:items-center md:justify-between md:gap-4">
          <Link
            aria-label={`Voltar para a página inicial da ${school.name}`}
            className="flex items-center gap-3 rounded-[1.2rem] px-2 py-1 transition hover:bg-white/45 sm:gap-4 sm:rounded-[1.4rem]"
            href="/"
          >
          ...
          <nav
            ...
            className="grid w-full grid-cols-3 gap-2 text-sm font-medium text-on-surface-variant md:flex md:w-auto md:flex-wrap md:items-center md:gap-4"
          >
            ...
            <a
              aria-label="Instagram oficial da escola (abre em nova aba)"
